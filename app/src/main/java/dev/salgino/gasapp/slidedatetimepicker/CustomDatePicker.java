...
public class CustomDatePicker extends DatePicker {
    ...
    public CustomDatePicker(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            selectionDividerField.set(dayNumberPicker, getResources().getDrawable(R.drawable.date_selection_divider));
            selectionDividerField.set(monthNumberPicker, getResources().getDrawable(R.drawable.date_selection_divider));
            selectionDividerField.set(yearNumberPicker, getResources().getDrawable(R.drawable.date_selection_divider));
        }
