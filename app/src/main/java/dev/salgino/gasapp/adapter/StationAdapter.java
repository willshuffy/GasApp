...
import dev.salgino.gasapp.activities.StationListActivity;
...
public class StationAdapter extends RecyclerView
        .Adapter<RecyclerView.ViewHolder>
{
    ...
    public StationAdapter(Context context, RecyclerviewClick listener) {
            ...
            (ViewGroup parent, int viewType)
    {
        ...
        switch (viewType) {
            case ITEM:
                View viewItem = inflater.inflate(R.layout.item_station, parent,
                        false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position)
    {
        ...
        switch (getItemViewType(position)) {
            ...
            case ITEM:
                ...
                viewHolder.tvSubtitle.setText(result.getAddress());
                ...
                viewHolder.cvRoot.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        ((StationListActivity)context).intentToStationData(result);
                    }
                });
                break;
