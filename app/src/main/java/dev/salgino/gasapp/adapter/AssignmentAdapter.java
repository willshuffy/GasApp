...
import dev.salgino.gasapp.activities.AssignmentListActivity;
...
public class AssignmentAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AssignmentAdapter(Context context, RecyclerviewClick listener) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case ITEM:
                View viewItem = inflater.inflate(R.layout.item_assignment, parent, false);
        ...
        switch (getItemViewType(position)) {
            ...
            case ITEM:
                ...
                viewHolder.cvRoot.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        ((AssignmentListActivity)context).intentToMaps(result);
                    }
                });
                break;
